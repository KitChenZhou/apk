...
public final class PermissionUtils {
    ...
    private static WeakReference<OnPermissionListener> mOnPermissionListenerRef;
    ...
    public static void requestPermissions(Context context, int requestCode
        ...
        if (context instanceof Activity) {
            ...
            mOnPermissionListenerRef = new WeakReference<OnPermissionListener>(listener);
            ...
            if (deniedPermissions.length > 0) {
                ...
                if (mOnPermissionListenerRef.get() != null)
                    mOnPermissionListenerRef.get().onPermissionGranted();
            }
        } else {
    ...
    public static void onRequestPermissionsResult(Activity context, int requestCode, String[] permissions, int[]
        ...
        if (mRequestCode != -1 && requestCode == mRequestCode) {
            if (mOnPermissionListenerRef.get() != null) {
                String[] deniedPermissions = getDeniedPermissions(context, permissions);
                if (deniedPermissions.length > 0) {
                    mOnPermissionListenerRef.get().onPermissionDenied(deniedPermissions);
                } else {
                    mOnPermissionListenerRef.get().onPermissionGranted();
                }
            }
