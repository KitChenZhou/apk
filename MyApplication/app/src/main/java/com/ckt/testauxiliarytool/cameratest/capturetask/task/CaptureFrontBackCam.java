...
public class CaptureFrontBackCam extends CaptureTask {

    public CaptureFrontBackCam(
    ...
    public Observable<Message> mObservable = Observable.create(new ObservableOnSubscribe<Message>() {
        @Override
